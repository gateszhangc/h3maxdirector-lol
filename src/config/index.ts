...
export const envConfigs: ConfigMap = {
  app_url: process.env.NEXT_PUBLIC_APP_URL ?? 'https://h3maxdirector.lol',
  app_name: process.env.NEXT_PUBLIC_APP_NAME ?? 'H3 Max Director',
  app_description:
    process.env.NEXT_PUBLIC_APP_DESCRIPTION ??
    'Direct continuous realtime video with live prompts while preserving characters, settings, and story continuity.',
