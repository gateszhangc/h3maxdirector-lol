      ...
      {isCheckSign || !mounted ? (
        ...
        <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
          <Button
            ...
            size={signButtonSize}
            className={cn(
              'bg-primary text-primary-foreground hover:bg-primary/90 cursor-pointer rounded-xl shadow-none ring-0 border-0',
          ...
          <SignModal callbackUrl={signCallbackUrl || '/'} />
        </div>
      )}
    </>
  );
