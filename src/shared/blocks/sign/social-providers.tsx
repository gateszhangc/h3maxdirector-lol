...
export function SocialProviders({
  ...
  // Only Google login is supported on this site.
  const googleConfigured = Boolean(configs.google_client_id?.trim());
  const isGoogleAuthEnabled =
    googleConfigured || configs.google_auth_enabled === 'true';
