...
export interface ContextValue {
  ...
  setSignCallbackUrl: (url: string) => void;
  configs: Record<string, string>;
  fetchConfigs: () => Promise<void>;
  fetchUserCredits: () => Promise<void>;
  fetchUserInfo: () => Promise<boolean | null>;
...
export const AppContextProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [isCheckSubscription, setIsCheckSubscription] = useState(false);

  // sign modal callback url
  const [signCallbackUrl, setSignCallbackUrl] = useState('/');
