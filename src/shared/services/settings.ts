...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    {
      name: 'waffo',
      title: t('groups.waffo'),
      description:
        'custom your <a href="https://pancake.waffo.ai/" class="text-primary" target="_blank">Waffo</a> settings',
      tab: 'payment',
    },
    {
...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      placeholder:
        'H3 Max Director creates continuous realtime video streams that respond to live prompts while preserving characters, settings, and story continuity.',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      tip: 'RSA private key in PEM format. This value is stored server-side and is never exposed to the browser.',
      group: 'waffo',
      tab: 'payment',
    },
    {
  ...
  "premium-yearly": "PROD_xxx"
      ...
      group: 'waffo',
      tab: 'payment',
      tip: 'Map the product_id in pricing table to <a href="https://pancake.waffo.ai/dashboard" class="text-primary" target="_blank">Waffo product</a>. Must be a valid JSON object.',
    },
    {
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'H3 Max Director <no-reply@h3maxdirector.lol>',
      group: 'resend',
      tab: 'email',
    },
    {
