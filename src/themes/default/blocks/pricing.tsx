  ...
  return (
    ...
    >
      <div className="mx-auto mb-12 px-4 text-center md:px-8">
        ...
        <h2 className="font-display mb-5 text-4xl font-semibold tracking-[-0.025em] text-pretty lg:text-5xl">
          {section.title}
        </h2>
      ...
      <div className="container">
        ...
        <div className="mx-auto mt-0 grid w-full gap-4 lg:grid-cols-3">
          {section.items?.map((item: PricingItem, idx) => {
            ...
            return (
              <Card
                key={idx}
                className={cn(
                  'border-border relative rounded-2xl shadow-xs',
                  item.is_featured &&
                    'border-[#a99cff] shadow-[0_18px_48px_rgba(118,87,255,.12)]'
                )}
              >
                {item.label && (
                  <span className="absolute inset-x-0 -top-3 mx-auto flex h-7 w-fit items-center rounded-xl bg-[#7657ff] px-3 py-1 text-xs font-semibold text-white shadow-sm ring-4 ring-background">
                    {item.label}
                  </span>
                )}
                ...
                <CardHeader>
                  ...
                  <div className="my-3 flex items-baseline gap-2">
                    ...
                    <div className="font-display my-3 block text-3xl font-semibold">
                  ...
                  {isCurrentPlan ? (
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        'mt-4 h-11 w-full rounded-xl px-4 py-2',
                        'border-0 bg-[#7657ff] text-white shadow-none hover:bg-[#6849ed]'
                      )}
                    >
